...
该项目实际上是我自己借助AI工具，还有舍友同学的帮助，以及参考伟大XDUSE先辈的rust函数解释器项目完成的python版本函数绘图解释器，很可能有我自己都没发现的BUG，也不那么具有什么特别的实际应用意义，请见谅。以下是项目说明

一个功能强大（弱小）的函数绘图语言解释器，支持多种数学函数和操作，帮助用户快速绘制和可视化数学函数图像。
